...
import { MOCK_OCR_SERVICES } from '@/mocks/ocr';
import { FilterTab, Month, MONTHS, PAYMENT_HISTORY, SERVICE_CATEGORIES, ServiceItem, SERVICES_BY_MONTH } from '@/mocks/services';
import { OcrField, SERVICES_CONFIG } from '@/constants/config';
