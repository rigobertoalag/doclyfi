...
export type { DocItem, DocStatus, FileType, ExtraField, LinkedDoc, DocumentDetail };
...
export const MOCK_DOCUMENTS: Record<string, DocumentDetail> = {
  'd11': {
    ...
    extraFields: [
      ...
      { label: 'Método de pago',   value: 'Transferencia SPEI', icon: 'swap-horizontal-outline', iconColor: '#0D9488' },
    ],
    linkedDocs: [
  ...
  'd01': {
    ...
    extraFields: [
      ...
      { label: 'Producto',         value: 'Audífonos Sony WH-1000XM5', icon: 'headset-outline', iconColor: '#7C3AED' },
  ...
  'd15': {
    ...
    extraFields: [
      ...
      { label: 'Tipo',            value: 'Prestación de Serv.', icon: 'briefcase-outline',    iconColor: '#7C3AED' },
    ],
    linkedDocs: [
